...
namespace Scrabble_v3_Tests.UnitTests
{
    ...
    public class BoardTileDto_UnitTests
    {
        ...
        {
            ExceptionAsserter.AssertExceptionWithMessageIsThrown(() => BoardTileDtoCreator.CreateTile(0, 1, 1, 1, true, "", 0), BoardTileDto.ID_BELOW_ONE);
        }
        
        [TestMethod]
        public void BoardIdBelowOneThrowsException()
        {
            ExceptionAsserter.AssertExceptionWithMessageIsThrown(() => BoardTileDtoCreator.CreateTile(1, 0, 1, 1, true, "", 0), BoardTileDto.BOARD_ID_BELOW_ONE);
        }
        
        [TestMethod]
        public void RowBelowOneThrowsException()
        {
            ExceptionAsserter.AssertExceptionWithMessageIsThrown(() => BoardTileDtoCreator.CreateTile(1, 1, 0, 1, true, "", 0), BoardTileDto.ROW_BELOW_ZERO);
        }
        
        [TestMethod]
        public void ColumnBelowOneThrowsException()
        {
            ExceptionAsserter.AssertExceptionWithMessageIsThrown(() => BoardTileDtoCreator.CreateTile(1, 1, 1, 0, true, "", 0), BoardTileDto.COLUMN_BELOW_ZERO);
        }
        ...
        {
            Assert.IsTrue(BoardTileDtoCreator.CreateTile(1, 2, 3, 4, true, "a", 5).ToString().Equals(
